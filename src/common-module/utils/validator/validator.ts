...
import { StringUtils } from '../convert/string.utlils';
...
export class Validator {
  static validate(constraints: FormField[], params: any): GeneralResponse {
    ...
    constraints.forEach((constraint: FormField) => {
      ...
      if (this.checkTooShord(constraint, params)) {
   ...
   * @returns 
   */
  private static checkTooShord(constraint: FormField, params: any): boolean {
